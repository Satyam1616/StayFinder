...
// import { Hotel, MapPin, BadgeCheck, Clock, XCircle, X } from "lucide-react"; // Import additional icons
...
//   useEffect(() => {
//     console.log("userListings from hook:", userListings);
//     setListings(userListings);
//     console.log(userListings);
//   }, [userListings]);
//   const totalSpent = listings.reduce((sum, booking) => {
//     // Only include bookings with these statuses in the total
...
//       // Update status locally if it's relevant
...
//                   <div
//                     key={booking._id}
//                     className="group w-full bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-gray-200 mb-4 last:mb-0"
//                   >
//                     <div className="flex flex-col md:flex-row h-auto md:h-40 group-hover:md:h-[350px] transition-all duration-500 ease-[cubic-bezier(0.33,1,0.68,1)]">
//                       {/* Image Section */}
//                       <div
//                         className="w-full md:w-64 h-48 md:h-full group-hover:md:h-[350px] relative overflow-hidden
...
//                       {/* Content Section */}
//                       <div className="flex-1 p-5 flex flex-col transition-all duration-300">
//                         <div className="flex justify-between items-start">
//                           <div>
...
//                         <div className="mt-4 flex flex-wrap gap-2 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300 delay-100">
//                           {Object.entries(booking.listing.amenities || {})
//                             .filter(([_, value]) => value)
//                             .map(([key]) => (
//                               <span
//                                 key={key}
//                                 className="px-2 py-1 bg-gray-100 text-gray-700 text-xs rounded-full capitalize hover:bg-blue-100 hover:text-blue-600 transition-colors"
//                               >
//                                 {key}
//                               </span>
//                             ))}
...
//                         <div className="mt-auto pt-4 flex gap-3 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-150">
//                           {booking.status === "approved" && (
//                             <>
//                               <button
//                                 onClick={() => handlePayment(booking._id)}
//                                 className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors hover:shadow-sm"
//                               >
...
//                                 className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors hover:shadow-sm"
//                               >
//                                 <X className="w-4 h-4" />
//                                 <span>Cancel</span>
//                               </button>
...
//                             <button
//                               onClick={() => handleCancelBooking(booking._id)}
//                               className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-red-100 text-red-600 rounded-lg hover:bg-red-200 transition-colors hover:shadow-sm"
//                             >
//                               <X className="w-4 h-4" />
